        ...
        <div className="flex flex-col text-start ">
          <div className=" border-l-[3px] border-black dark:border-white   ">
            <div className="relative ml-[30px] sm:ml-[65px] mb-16 ">
              ...
              <div className="  text-xl mb-3 font-bold">2018-2020</div>
              <p className="font-medium text-black dark:text-white">
                I have completed my high school in Non-medical Stream from
                Government Senior Secondary School, Jhajjar, Haryana in 2020-22
                session.
              </p>
            ...
            <div className="relative ml-[30px] sm:ml-[65px] ">
              ...
              <div className="  text-xl mb-3 font-bold">2020-Present</div>
              <p className="font-medium text-black dark:text-white">
                I'm currently pursuing Bachelor's in Compute Science and
                Engineering from Ganga Institute of Technology and Management
                located at Kablana, Jhajjar.
              </p>
              <span className=" absolute top-0 left-0  flex justify-center align-middle items-center  w-[27px] h-[27px]  sm:w-[30px] sm:h-[30px] bg-white dark:bg-black border-black dark:border-white  border-[3px] -ml-[45px] sm:-ml-[81px] rounded-[50%]">
                <span className="w-[12px] h-[12px] sm:w-[15px] sm:h-[15px] bg-black dark:bg-white  rounded-[50%]"></span>
              </span>
          ...
          <div className="flex flex-col text-start ">
            <div className=" border-l-[3px] border-black dark:border-white  ">
              <div className="relative ml-[30px] sm:ml-[65px]  ">
                ...
                <p className="font-medium text-black dark:text-white">
                  After completing High School, i've been actively involved in
                  the Web Development community and i've built some projects
                  during this period of time from which i get good amount of
                  experience about this field.
                </p>
                <span className=" absolute top-0 left-0  flex justify-center align-middle items-center  w-[27px] h-[27px]  sm:w-[30px] sm:h-[30px] bg-white dark:bg-black border-black dark:border-white  border-[3px] -ml-[45px] sm:-ml-[81px] rounded-[50%]">
                  <span className="w-[12px] h-[12px] sm:w-[15px] sm:h-[15px] bg-black  dark:bg-white  rounded-[50%]"></span>
                </span>
